...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
    ...
    */
    ...
    if (!is_initialized_) {
        ...
        cout << "The UKF is initialized!" << endl;
        return;
    }
    ...
    cout << "x_ = " << x_ << endl;
    cout << "P_ = " << P_ << endl;
    cout << "NIS over times "<<over_<<endl;
}
...
void UKF::Prediction(double delta_t) {
    ...
    for (int i=0; i<2*n_aug_+1; i++){
        //extract value from sigma points matrix
...
void UKF::UpdateLidar(MeasurementPackage meas_package) {
    //Using linear method to update lidar measurement
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
    ...
    //mean predicted measurement and covariance
